...
export class News extends Component {
    ...
    async componentDidMount(){
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=5716ebcff2884536a813eaa6042b94c7&page=1&pageSize=${this.props.pageSize}`;
    ...
    handleNextClick = async() => {
            let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=5716ebcff2884536a813eaa6042b94c7&page=${this.state.page + 1}&pageSize=${this.props.pageSize}`;
            this.setState({loading: true});
            let data = await fetch(url);
            let parseData = await data.json();
            this.setState({
